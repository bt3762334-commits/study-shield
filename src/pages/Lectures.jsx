...
export default function Lectures() {
  ...
  const activeLectures = lectures.filter(l => !l.completed);
  ...
  return (
    <MainLayout>
      ...
      <div className="section-card">
        ...
        <div className="tasks-list">
          {activeLectures.map(lecture => (
            <div key={lecture.id} className="task-card">
              ...
              <div className="task-content">
                ...
                <div className="task-meta">
                  ...
                  {lecture.time && <span>⏰ {lecture.time}</span>}
                </div>
              </div>
              ...
              <div className="task-actions">
                ...
                <button type="button" className="delete" onClick={() => deleteLecture(lecture.id)}>
                  حذف
                </button>
              </div>
      ...
      <div className="section-card">
        <h2>✅ المحاضرات المكتملة</h2>

        <div className="tasks-list">
          {completedLectures.map(lecture => (
            <div key={lecture.id} className="task-card">
              <div className="task-content">
                <span className="completed">{lecture.title}</span>
              </div>
            </div>
          ))}
        </div>
